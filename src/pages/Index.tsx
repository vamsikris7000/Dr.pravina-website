...
import { Calendar, Mail, BookOpen, Heart, Star, Users, MessageSquare, Instagram, Facebook, Linkedin, Youtube, Award } from "lucide-react";
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="text-center lg:text-left animate-fade-in-up px-4 sm:px-0 w-full col-span-2">
              ...
              <div className="mt-8 md:mt-10 max-w-4xl mx-auto lg:mx-0">
                <h3 className="font-playfair text-2xl md:text-3xl font-bold text-white text-center lg:text-left">
                  Caring for Your Health, So You Can Care for Your World
                </h3>
              </div>
            </div>
