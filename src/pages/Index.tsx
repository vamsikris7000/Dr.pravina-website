...
const Index = () => {
  ...
  const testimonials = [
    ...
    },
    {
      name: "Manali Ahire",
      location: "Pune",
      photo: "/photos/Testimonials9.png",
      message: "I'm 27 years old, and for the past 12 years I tried everything to control my blood sugar and weight. When other doctors told me the only option left was to switch from oral medication to insulin, I felt hopeless. That's when I consulted with Pravina. She guided and motivated me to make sustainable lifestyle changes — and it worked wonders. Within just 2 months, not only did my blood sugar levels come down, but I also lost weight, improved my skin, and started feeling healthier overall. For the first time in years, I feel truly in control of my health and my life."
    },
