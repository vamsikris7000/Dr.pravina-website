// RAG Training Data for Path'o'Life Workshops
// This data helps the chatbot provide accurate responses about workshop registration
...
export const workshopRAGData = {
  workshops: [
    ...
    {
      name: "Pre-Pregnancy Power Couple",
      fullName: "👫🏻 Pre-Pregnancy Power Couple",
    ...
    {
      name: "Pregnancy Wellness Workshop",
      fullName: "🤰🏻 Pregnancy Wellness Workshop",
    ...
    {
      name: "Confident Breastfeeding & Postpartum Healing",
      fullName: "🤱🏻 Confident Breastfeeding & Postpartum Healing",
    ...
    {
      name: "First Foods & Beyond",
      fullName: "🍲 First Foods & Beyond",
  ...
  generalInfo: {
    platform: "All workshops are conducted live on Google Meet",
    duration: "Each workshop is a 3-hour deep-dive session",
    languages: "Available in English, Hindi, and Marathi",
    includes: [
      "Downloadable checklists & lifestyle toolkits",
      "Expert Q&A session", 
    ...
    registrationProcess: [
      "Choose your workshop and secure your spot with easy online registration",
      "Pay securely via UPI and upload payment screenshot to confirm enrollment",
      "Receive comprehensive toolkits, checklists, and actionable materials"
    ],
...
// Helper function to find workshop by name
export const findWorkshopByName = (name: string) => {
  const searchName = name.toLowerCase();
  return workshopRAGData.workshops.find(workshop => 
    workshop.name.toLowerCase().includes(searchName) ||
    workshop.fullName.toLowerCase().includes(searchName) ||
    workshop.subtitle.toLowerCase().includes(searchName)
  );
};

// Helper function to get workshop registration response
export const getWorkshopRegistrationResponse = (workshopName: string) => {
  const workshop = findWorkshopByName(workshopName);
  if (workshop) {
    return workshop.chatbotResponses.registration;
  }
  return "I'd be happy to help you register for a workshop! We offer 6 different workshops covering various aspects of women's health. Could you please specify which workshop you're interested in?";
}; 